...
from scripts.dataset_gen.hdf52png import hdf52png
from scripts.dataset_gen.RGBD2PC import backproject, visualize_points
import cv2
import numpy as np
...
def pcd_mask_preprocessing(points_scene, points_no_obj_scene = None):
    ...
    for white_point in tqdm(selected_white_points, desc="Processing white points"):
        ...
        if not check_collision(green_pcd, blue_pcd, threshold=10): # 阈值需要大 因为点其实残缺和稀疏
            ...
            if np.sqrt((white_point[0] - green_bbox_max_center[0])**2 + (white_point[1] - green_bbox_max_center[1])**2) < 100:
...
if __name__ == "__main__":
    ...
    RGBD2MaskPC(depth_path="dataset/scene_RGBD_mask/id162_1/lamp_0004_orange/with_obj/test_pbr/000000/depth/000000.png",
                mask_hd5f_path="dataset/scene_RGBD_mask/id162_1/lamp_0004_orange/with_obj/0.hdf5",
                output_dir="dataset/scene_RGBD_mask/id162_1/lamp_0004_orange",
                reprocessing_flag=True,
                depth_removed_obj= "dataset/scene_RGBD_mask/id162_1/lamp_0004_orange/no_obj/test_pbr/000000/depth/000000.png",
                mask_hd5f_removed_obj="dataset/scene_RGBD_mask/id162_1/lamp_0004_orange/no_obj/0.hdf5")
