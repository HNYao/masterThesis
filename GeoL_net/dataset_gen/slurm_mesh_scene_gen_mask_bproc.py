...
def main(opt_cmd):
    ...
    script_cmd = ""
    opt_cmd.update({"log_dir": "/home/stud/zhoy/MasterThesis_zhoy/outputs/logs/dataset_gen_1k/"})
    ...
    with open(job_file, "w") as fh:
        ...
        # )
        fh.writelines(f"srun blenderproc run /home/stud/zhoy/MasterThesis_zhoy/GeoL_net/dataset_gen/mesh_scene_gen_mask_bproc.py \n")
