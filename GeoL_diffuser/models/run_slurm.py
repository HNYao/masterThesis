...
def main(opt_cmd):
    ...
    script_cmd = ""
    opt_cmd.update({"log_dir": "/home/stud/zhoy/MasterThesis_zhoy/outputs/logs/GeoL_diffuser/"})
    ...
    with open(job_file, "w") as fh:
        ...
        # )
        fh.writelines(f"srun /home/stud/zhoy/anaconda3/envs/o2o/bin/python GeoL_diffuser/models/diffusion.py \n")
