...
def main(opt_cmd):
    job_name = "dataset_gen_mask_turbo"
    ...
    script_cmd = ""
    opt_cmd.update({"log_dir": "/home/stud/zhoy/MasterThesis_zhoy/outputs/logs/dataset_gen_mask_turbo/"})
    ...
    with open(job_file, "w") as fh:
        ...
        # )
        fh.writelines(f"srun /home/stud/zhoy/anaconda3/envs/o2o/bin/python /home/stud/zhoy/MasterThesis_zhoy/GeoL_net/dataset_gen/RGBD2MaskPC.py \n")
