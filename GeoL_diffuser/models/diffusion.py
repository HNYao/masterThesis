...
class Diffusion(nn.Module):
    ...
    def get_aux_info(self, data_batch):
        ...
        top_positions[..., 2] = 0.8 # set cam_scene_angle
        ...
        top_positions_non_cond = self.scale_xyR_pose(top_positions_non_cond, data_batch["gt_pose_xyR_min_bound"], data_batch["gt_pose_xyR_max_bound"])

        top_positions_non_cond = top_positions_non_cond.reshape(-1, 80*3)
