...
def main(opt_cmd):
    ...
    script_cmd = ""
    opt_cmd.update({"log_dir": "/home/stud/zhoy/MasterThesis_zhoy/outputs/logs/GeoL_1K/"})
    ...
    with open(job_file, "w") as fh:
        ...
        # )
        fh.writelines(f"srun /home/stud/zhoy/anaconda3/envs/o2o/bin/python /home/stud/zhoy/MasterThesis_zhoy/GeoL_net/run.py \n")
