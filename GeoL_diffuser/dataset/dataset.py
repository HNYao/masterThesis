...
class PoseDataset_overfit(Dataset):
    def __init__(self,
        ...
        self.files = ["dataset/scene_RGBD_mask_v2_kinect_cfg/id3/bowl_0001_wooden/mask_Front.ply", "dataset/scene_RGBD_mask_v2_kinect_cfg/id9/clock_0001_normal/mask_Left Front.ply"]
    ...
    def __getitem__(self, index) -> Any:
        ...
        # get color and depth
        color_path = pc_path.rsplit("/", 1)[0] + "/no_obj/test_pbr/000000/rgb/000000.jpg"
        depth_path = pc_path.rsplit("/", 1)[0] + "/no_obj/test_pbr/000000/depth/000000.png"
        ...
        sample = {
            ...
            "gt_pose_4d": torch.cat((max_green_point, obj_rotation), dim=0).unsqueeze(0).repeat(8, 1),
...
class PoseDataset_affordance_overfit(Dataset):
    ...
    def __getitem__(self, index) -> Any:
        ...
        sample = {
            ...
            "gt_pose_4d_max_bound":max_bound, #[4,]
            "pc_position_xy_affordance": fps_points_scene_affordance[:, :2], #[num_affordance, 2]
            "gt_pose_xyR": torch.cat((max_green_point[:2], obj_rotation), dim=0).unsqueeze(0).repeat(8, 1), #[8, 3]
            "gt_pose_xyR_min_bound":np.delete(min_bound_affordance, 2, axis=0), #[3,]
            "gt_pose_xyR_max_bound":np.delete(max_bound_affordance, 2, axis=0), #[3,]
            "tsdf_grid": tsdf_grid, 
        }
