...
class GeoL_net(nn.Module):
    def __init__(self, input_shape, target_input_shape):
        ...
        self.clipunet_module = CLIPUNet(input_shape=input_shape, target_input_shape=target_input_shape, output_dim=16)
        ...
        self.instrics = np.array([[591.0125 ,   0.     , 322.525  ],
            ...
            [  0.     ,   0.     ,   1.     ]])
        self.fusion_point_moudule = FusionPointLayer()
    ...
    def inference_4cls(self):
        ...
        o3d.io.write_point_cloud("outputs/point_cloud_4cls.ply", point_cloud)
