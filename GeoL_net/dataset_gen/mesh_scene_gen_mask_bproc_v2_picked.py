...
def bproc_gen_mask_with_and_without_obj(scene_mesh_json, RGBD_out_dir, removed_obj_path_list=None, anchor_obj_path_list=None):
...
if __name__ == "__main__":
    ...
    parent_dir = "dataset/picked_scene_RGBD_mask"
    scene_id = json_file.split("/")[-1].split(".")[0]
