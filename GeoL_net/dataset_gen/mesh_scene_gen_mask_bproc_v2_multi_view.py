...
def bproc_gen_mask_with_and_without_obj(
    ...
    for obj_file_name, obj_pose in data.items():
        ...
        scale_factor = [1.2*target_size[0] / current_size[0], 1.2*target_size[1] / current_size[1], 1.2*target_size[2] / current_size[2]]
...
if __name__ == "__main__":
    ...
    for json_file_path in json_files:
        ...
        parent_dir = "dataset/multi_view/right_view"
        scene_id = json_file.split("/")[-1].split(".")[0]
        ...
        scene_id_file = os.path.join(parent_dir,scene_id)
